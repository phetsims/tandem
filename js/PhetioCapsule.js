...
PhetioCapsule.PhetioCapsuleIO = parameterType => {
  ...
  if ( !cache.has( parameterType ) ) {
    cache.set( parameterType, new IOType( `PhetioCapsuleIO<${parameterType.typeName}>`, {
      ...
      // TODO: see https://github.com/phetsims/tandem/issues/233 would a better default be "instance" or "element"?
      // TODO: see https://github.com/phetsims/tandem/issues/233 Review the occurrences and see if a name is reused.
